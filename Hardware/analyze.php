...
echo "</ul>";
echo "<hr><h3>Your Hardware Against Recommended High-End PC </h3>";
echo "<h3><strong>CPU:</strong> Ryzen 7 7800X3D | <strong>GPU:</strong> RTX 5070 Ti | <strong>RAM:</strong> 32GB </h3>";
...
echo "<strong>RAM:</strong> {$ramAmount}GB (" . htmlspecialchars($ramPerformance) . "% performance)<br><br>";
$conn->close();